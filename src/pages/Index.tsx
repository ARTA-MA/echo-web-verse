        ...
        <div className="container relative z-10 mx-auto px-4 text-center mt-16 md:mt-24">
          ...
          ease: "easeOut"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <MotionButton onClick={handleCTAClick} className="btn-primary group relative overflow-hidden" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }} initial={{
              ...
              duration: 0.5
                ...
                <motion.div className="absolute inset-0 bg-gradient-to-r from-purple-700 to-indigo-700" initial={{
                x: "100%"
              }} whileHover={{
                x: 0
              }} transition={{
              ...
              <MotionButton variant="outline" className="hover-scale relative overflow-hidden" onClick={handleLearnMore} whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }} initial={{
          ...
          <MotionButton onClick={scrollToFeatures} variant="ghost" className="mt-16" whileHover={{
          scale: 1.1
        }} animate={{
          y: [0, 10, 0]
        }} transition={{
