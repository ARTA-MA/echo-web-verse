...
const Index = () => {
  ...
  return <div className="min-h-screen overflow-x-hidden">
      ...
      <div ref={heroRef} className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden" style={{
      backgroundImage: "linear-gradient(180deg, rgba(107,33,168,0.1) 0%, rgba(255,255,255,0) 100%)"
        ...
        <MotionDiv className="absolute inset-0 z-0" style={{
        ...
        <MotionDiv className="absolute top-0 left-0 w-[500px] h-[500px] rounded-full blur-3xl opacity-20 bg-purple-600" animate={{
        x: -scrollY * 0.3,
        y: scrollY * 0.2,
        ...
        <MotionDiv className="absolute bottom-0 right-0 w-[300px] h-[300px] rounded-full blur-3xl opacity-10 bg-indigo-600" animate={{
        x: scrollY * 0.3,
        y: -scrollY * 0.2,
        scale: 1 - scrollY * 0.0005
      }} transition={{
        ...
        <div className="particle-container absolute inset-0 z-0 overflow-hidden opacity-60">
          {Array.from({
          length: 15
        }).map((_, i) => <MotionDiv key={i} className="absolute rounded-full bg-purple-400 dark:bg-purple-600" style={{
        ...
        <div className="container relative z-10 mx-auto px-4 text-center mt-16 md:mt-24">
          ...
          ease: "easeOut"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <MotionButton onClick={handleCTAClick} className="btn-primary group" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }} initial={{
              ...
              <MotionButton variant="outline" className="hover-scale" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }} initial={{
          ...
          <MotionDiv className="mt-16" animate={{
          y: [0, 10, 0]
        }} transition={{
          duration: 2,
          repeat: Infinity,
          ease: "easeInOut"
            ...
            <ArrowDownIcon className="mx-auto h-8 w-8 text-gray-400 dark:text-gray-500 cursor-pointer hover:text-purple-600 dark:hover:text-purple-400 transition-colors" onClick={() => {
            window.scrollTo({
      ...
      <section className="py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <MotionDiv className="text-center mb-16" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            icon: "🌓"
          }].map((feature, index) => <MotionDiv key={index} className="glass-card p-6" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <MotionDiv className="absolute inset-0" animate={{
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          duration: 0.8
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <MotionButton size="lg" onClick={() => window.dispatchEvent(new CustomEvent('open-auth-modal', {
              detail: {
                type: 'register'
              }
            }))} className="bg-white text-purple-700 hover:bg-gray-100" whileHover={{
              scale: 1.05,
              ...
              <MotionButton variant="outline" size="lg" whileHover={{
              scale: 1.05,
