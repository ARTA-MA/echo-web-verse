      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">About Arta's WebSite</span>
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">My journey to create the most interactive and beautiful web experience.</p>
        </div>
        ...
        <section className="mb-24">
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {timelineItems.map((item, index) => <div key={index} ref={el => timelineRefs.current[index] = el} data-index={index} className={`relative flex flex-col md:flex-row ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"} items-center`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            tooltip: "Implementing secure authentication and database interactions"
                ...
                <Card className="glass-card p-6 h-full flex flex-col items-center text-center">
                  ...
                  {index < 2 && <div className="hidden md:block absolute top-1/2 -right-3 transform translate-x-[50%] z-10">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-purple-500 dark:text-purple-400" />
                      </svg>
                    </div>}
